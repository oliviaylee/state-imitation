...
from bimanual_imitation.algorithms.configs import ALG, DiffusionStateParamConfig
...
class ImitateDiffusionState(ImitateBcBase):
    ...
    def init_params(self, cfg: DiffusionStateParamConfig):
        ...
        self._obs_dim = 46 * self.train_dataset.obs_horizon
        self._action_dim_single = 23
        del tmp_env
    ...
    def suggest_hyperparams(self, trial: optuna.Trial):
        param_cfg = DiffusionStateParamConfig(
